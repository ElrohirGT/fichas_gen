...
fn random_email<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let emails = vec![
        String::from("tracto@uvg.edu.gt"),
        String::from("something@uvg.edu.gt"),
        String::from("palabra@uvg.edu.gt"),
        String::from("uba@uvg.edu.gt"),
        String::from("portal@uvg.edu.gt"),
        String::from("palanca@uvg.edu.gt"),
        String::from("hotel@uvg.edu.gt"),
    ];

    emails.into_iter().choose(rng).unwrap()
}
fn random_food<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let food = vec![
        String::from("Lácteos"),
        String::from("Maní"),
        String::from("Mariscos"),
    ];

    food.into_iter().choose(rng).unwrap()
}
fn random_bone<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let bones = vec![
        String::from("Clavícula"),
        String::from("Fémur"),
        String::from("Costilla"),
        String::from("Cráneo"),
        String::from("Tibia"),
    ];

    bones.into_iter().choose(rng).unwrap()
}
fn random_surgery<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let surgeries = vec![
        String::from("Cardíaca"),
        String::from("Hepática"),
        String::from("Extirpación de Glándula"),
        String::from("Reparación de Hernia"),
    ];

    surgeries.into_iter().choose(rng).unwrap()
}
fn random_medicine<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let medicine = vec![
        String::from("Abacavir"),
        String::from("Tabcin"),
        String::from("Abilify"),
        String::from("Absorbine"),
        String::from("Abstral"),
        String::from("L-glutamina"),
        String::from("L-Triyodotironinaver Liotironina"),
        String::from("Labetalol"),
        String::from("Labid"),
        String::from("Lac-Hydrinver Lactato de amonio tópico"),
        String::from("Lacosamida"),
        String::from("Lactato de amonio tópico"),
        String::from("Lactulosa"),
        String::from("Ladakamycinver Azacitidina Inyectable"),
        String::from("Lagevrio"),
    ];

    medicine.into_iter().choose(rng).unwrap()
}

fn random_sickness<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let sickness = vec![
        String::from("Anotia"),
        String::from("Microtia"),
        String::from("Anoftalmía"),
        String::from("Microftalmía"),
        String::from("Craneosinostosis"),
        String::from("Atresia Pulmonar"),
        String::from("Espina Bífida"),
        String::from("Tronco Arterioso"),
    ];

    sickness.into_iter().choose(rng).unwrap()
}

fn random_female_sickness<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let sickness = vec![
        String::from("Cáncer de mama"),
        String::from("Cáncer de cuello uterino"),
        String::from("Quistes ováricos"),
        String::from("Enfermedad Inflamatoria Pélvica"),
    ];

    sickness.into_iter().choose(rng).unwrap()
}

fn random_insurance_company<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let companies = vec![
        String::from("El Roble"),
        String::from("Yap"),
        String::from("BBVA Seguros"),
        String::from("Aseguradora General"),
        String::from("Seguros MAPFRE"),
    ];

    companies.into_iter().choose(rng).unwrap()
}

fn random_insurance<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let ensurances = vec![
        String::from("Carro"),
        String::from("Casa"),
        String::from("Motocicleta"),
        String::from("Vida"),
    ];

    ensurances.into_iter().choose(rng).unwrap()
}

fn random_relationship<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    ...
    relationship.into_iter().choose(rng).unwrap()
}

fn random_last_names<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let last_names = vec![
        String::from("Paz"),
        String::from("Donis"),
        String::from("Mancía"),
        String::from("Salazar"),
        String::from("Roldán"),
        String::from("Sagastume"),
        String::from("Arroyo"),
        String::from("Paniagua"),
        String::from("Pineda"),
    ];
...
fn random_names<R: rand::Rng + ?Sized>(rng: &mut R) -> String {
    let names = vec![
        String::from("Flavio"),
        String::from("Andre"),
        String::from("Gaby"),
...
fn random_date<R: rand::Rng + ?Sized>(rng: &mut R, start_year: i32, end_year: i32) -> String {
